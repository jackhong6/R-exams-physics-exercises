...
\usepackage{graphicx,xcolor,verbatim,url,fancyvrb,xargs,amsmath,amssymb,booktabs,longtable,textcomp,eurosym,latexsym}
...
%% headings
\markboth{\textnormal{\bf \large Exam: \myID}}%
{\textnormal{\bf \large Exam: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{McRoberts Secondary}}

\textbf{\large{Physics Exam \myDate \hfill Exam ID \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Name:} \hrule \\[1.5cm]
\textbf{Student Number:} \hrule \\[1.5cm]
