...
sc$questions <- paste("$", gsub("^ +", "", sc$questions), "\\text{ km/h}$", sep = "")
```

Question
========
A truck travels at $`r v1`$ km/h for $`r t1`$ hours and at $`r v2`$ km/h for $`r t2`$ hours. What is the average speed for the trip?
...
$$ v_{avg} = \frac{d_{total}}{t_{total}} = \frac{v_1 t_1 + v_2 t_2}{t_1 + t_2}$$
