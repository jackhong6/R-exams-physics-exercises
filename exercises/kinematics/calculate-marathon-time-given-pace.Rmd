...
Question
========
A runner completes a marathon (\SI{42.195}{km}) with an average pace of \SI{`r pace_minutes`}{minutes} and \SI{`r pace_seconds`}{seconds} per \si{kilometre}. What is the runner's time for the marathon? (Answers are formatted as \si{hours:minutes:seconds})
