...
Solution
========
Since the torque on the seesaw is balanced, we must have $\tau_{net} = (m_{1} d_{1} + \tau_s) - (m_{2} d_{2} + \tau_s) = m_1 d_1 - m_2 d_2 = 0$, where $\tau_s$ is the torque from weight of the seesaw, $m_1$ and $d_1$ are the mass and distance of the lighter child, and $m_2$ an $d_2$ are the mass and distance of the heavier child. 
...
Halving both distances will result in $\tau_{net} = (m_1 (d_1/2) + \tau_s) - (m_2 (d_2/2) + \tau_s) = \frac{1}{2}(m_1 d_1 - m_2 d_2) = 0$. Therefore, the seesaw will still be balanced.
