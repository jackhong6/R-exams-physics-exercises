...
sc <- num_to_schoice(ans, delta = 0.01, range = c(0.1*ans ,sep), format = FALSE)
...
$$x = \frac{s}{m_{rock}} \left(m_{right} - \frac{m_{plank}}{2} \right) = \frac{\SI{`r sep`}{m}}{\SI{`r rock_mass`}{kg}} \left(\SI{`r right_mass`}{kg} - \frac{\SI{`r plank_mass`}{kg}}{2} \right) = \SI{`r signif(ans, 3)`}{m}$$
