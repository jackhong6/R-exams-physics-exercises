...
Question
========
A uniform beam $QR$, $\SI{1.0}{\meter}$ long with negligible mass, is mounted by a hinge on a wall and held in position by a horizontal wire $PQ$ as shown in the figure. The beam supports a load of mass $\SI{`r mass`}{\kg}$ hanging vertically down from point $Q$. What is the magnitude of the net force on the hinge at point $R$?
