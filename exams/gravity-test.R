...
set.seed(s)
exams2nops(exm, n = 3, date = as.Date("2025-11-14"), edir = "exercises", title = "Circular Motion and Gravity Test", 
...
set.seed(s)
exams2pdf(exm, n = 3, edir = "exercises", template = "templates/solution.tex", 
          header = list(Course = "Physics 11", Title = "Circular Motion and Gravity Test Solutions"),
