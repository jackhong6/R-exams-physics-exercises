...
set.seed(2025*10*22)
statics_retest <- c(sample(concept), sample(calc))

set.seed(2025*10*22)
exams2nops(statics_retest, n = 3, date = as.Date("2025-10-22"), edir = "exercises", title = "Physics 12 Statics Retest", 
           course = "Physics 12", institution = "McRoberts Secondary", logo = "graphics/school-logo.png", 
           blank = 0, samepage = TRUE, dir = "statics-tests", name = "phys12-statics-retest", helvet = TRUE,
           usepackage = c("siunitx", "eulervm"))
