...
name <- "circuits-retest"
s <- 2025*1*21

set.seed(s)
exams2nops(exm, n = 2, date = as.Date("2025-01-21"), edir = "exercises", title = "Circuits Unit Retest", 
...
exams2pdf(exm, n = 2, edir = "exercises", template = "templates/solution.tex", 
          header = list(Course = "Physics 11", Title = "Circuits Unit Retest Solutions"),
